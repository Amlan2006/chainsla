...
const workerConfigSchema = z.object({
  ...
  slaRegistryContract: z.string().optional(),
  slaEvaluationBatchSize: z.coerce.number().int().positive().default(25),
...
export function loadWorkerConfig(env: NodeJS.ProcessEnv = process.env): WorkerConfig {
  return workerConfigSchema.parse({
    ...
    slaRegistryContract: env.SLA_REGISTRY_CONTRACT,
    slaEvaluationBatchSize: env.SLA_EVALUATION_BATCH_SIZE,
